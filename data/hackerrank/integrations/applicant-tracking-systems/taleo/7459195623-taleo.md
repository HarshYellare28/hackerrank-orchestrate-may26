...
An Assessment Suite is a combination of one or more code.tests and/or interviews. As part of your configuration, you will need to fetch a list of assessment suite IDs and names from your HackerRank for Work account.
...
As noted above, an Assessment Suite is a specification of a sequence of code.tests and interviews. If you have a test you want to administer, you should first set that up in the 'Tests' tab before proceeding.
...
Each phase can be either a test or an interview. Select one of the options from the drop-down. If you select Test, you will then be shown a list of all the code.tests in your account:
